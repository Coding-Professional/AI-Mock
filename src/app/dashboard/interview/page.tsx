          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                <Badge variant={
                  interviewState.status === 'recording' ? 'default' :
                    interviewState.status === 'paused' ? 'secondary' : 'outline'
                }>
                  {interviewState.status === 'recording' ? 'Recording' :
                    interviewState.status === 'paused' ? 'Paused' : 'Completed'}
                </Badge>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your interview session will be recorded for analysis and feedback
              </CardDescription>
            </CardHeader>
            <CardContent>
              <VideoRecorder
                ...
                onPermissionChange={(hasPermissions) =>
                  setInterviewState(prev => ({ ...prev, hasPermissions }))
                }
              />
            </CardContent>
          </Card>
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {interviewState.status === 'setup' && (
                  <Button
                    ...
                    disabled={!interviewState.hasPermissions}
                  >
            ...
            <Alert>
              ...
              <AlertDescription>
                <div className="space-y-2">
                  ...
                  <p>Your responses are being analyzed. You&apos;ll receive detailed feedback and suggestions for improvement shortly.</p>
                </div>
              </AlertDescription>
            </Alert>
          )}
